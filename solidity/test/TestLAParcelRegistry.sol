...
contract TestLAParcelRegistry {
  ...
  function testAddedParcelValuesUsingDeployedContract() public {
    ...
    bytes32 csc1 = meta.claimParcel(dggsIndex1, wkbHash, addr1, label1, area, landUseCode1);
    bytes32 csc2 = meta.claimParcel(dggsIndex2, wkbHash, addr2, label2, area, landUseCode2);
    ...
    (bytes32 csc, string memory lbl, string memory addr, string memory landUse, uint ar) = parcel1.fetchParcel();
    ...
    (csc, lbl, addr, landUse, ar) = parcel2.fetchParcel();
