...
contract('LAParcelRegistry', function (accounts) {
  ...
  it("Should revert if the caller is not an Admin", async () => {
    ...
    await truffleAssert.passes(parcel.setExtAddressId(addr2, { from: alice }), truffleAssert.ErrorType.REVERT);
    await truffleAssert.fails(parcel.setExtAddressId(addr2, { from: bob }), truffleAssert.ErrorType.REVERT);
    ...
    await truffleAssert.passes(parcel.setParcelType(parcel2Type, { from: alice }), truffleAssert.ErrorType.REVERT);
    await truffleAssert.fails(parcel.setParcelType(parcel2Type, { from: bob }), truffleAssert.ErrorType.REVERT);
